...
begin
  dbgrdFBProcurarEmpresa.DataSource  := DataModule.dsConexaoPadrao;
end;
...
begin
  ...
  case rgTipoPesquisa.ItemIndex of
    0: Found := DataModule.qryConexaoPadrao.Locate('NOMEFANTASIA' , edtPesquisar.Text, [loPartialKey]);
    1: Found := DataModule.qryConexaoPadrao.Locate('IDRETORNO'    , edtPesquisar.Text, [loPartialKey]);
  end;
