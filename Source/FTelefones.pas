...
implementation
uses
  uFuncoes, FProcurarTelefone, FProcurarTipoTelefone;
...
begin
  try
    ...
    frmProcurarTelefone.Sql.Text := CtrlTelefones.MontaSqlProcurarTelefone(CtrlClientes.Id_Cliente);
    ...
    frmProcurarTelefone.dbgrdFBProcurarTelefone.Columns.Items[1].Title.Caption := 'Nome Cliente';
    frmProcurarTelefone.dbgrdFBProcurarTelefone.Columns.Items[1].Width         := 400;
